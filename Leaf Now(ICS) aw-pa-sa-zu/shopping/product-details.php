					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								...
								<li class="active"><a data-toggle="tab" href="#merchantdetails">MERCHANTS DETAILS</a></li>
								<li class="active"><a data-toggle="tab" href="#warranty">WARRANTY AND GUIDE</a></li>
								<li class="active"><a data-toggle="tab" href="#cancellations">RETURNS AND CANCELLATIONS</a></li>
						...
						<div class="col-sm-9">
							...
							<div class="tab-content">
								...
								<div id="information" class="tab-pane in active">
									<div class="product-tab">
										<p class="text"><?php echo $row['information'];?></p>
									</div>	
								</div>
								<div id="instruction" class="tab-pane in active">
									<div class="product-tab">
										<p class="text"><?php echo $row['instruction'];?></p>
									</div>	
								</div>
								<div id="merchantdetails" class="tab-pane in active">
									<div class="product-tab">
										<p class="text"><?php echo $row['merchantdetails'];?></p>
									</div>	
								</div>
								<div id="warranty" class="tab-pane in active">
									<div class="product-tab">
										<p class="text"><?php echo $row['warranty'];?></p>
									</div>	
								</div>
								<div id="cancellations" class="tab-pane in active">
									<div class="product-tab">
										<p class="text"><?php echo $row['cancellations'];?></p>
									</div>	
								</div><!-- /.tab-pane -->

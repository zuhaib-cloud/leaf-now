...
<html lang="en">
	<head>
	    ...
	    <title>Plant shop | Signi-in | Signup</title>
...
<div class="form-group">
	    	...
	    	<input type="text" class="form-control unicase-form-control text-input"  maxlength="10" pattern="\d{10}" title="please insert correct a phone number " required>
	  	</div>
<div class="form-group">

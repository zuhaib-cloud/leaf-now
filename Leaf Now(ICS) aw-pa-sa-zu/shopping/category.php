...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="assets/css/bootstrap-select.min1.css">
		<link rel="stylesheet" href="assets/css/style1.css">
		<link rel="stylesheet" href="assets/css/jquery-ui1.css">
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active " id="grid-container">
							<div class="category-product  inner-top-vs">
								<div class="row">									
			<?php
$ret=mysqli_query($con,"select * from products where category='$cid' and productPrice BETWEEN '$min' AND '$max'");

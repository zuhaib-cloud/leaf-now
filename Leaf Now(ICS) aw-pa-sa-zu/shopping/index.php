...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
	    ...
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/slider0.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">easy shipping</h4>
						</div>
					</div>
					<h6 class="text">easy shipping all over the country </h6>	
				</div>
			</div><!-- .col -->
...
?>
	...
	<?php } ?>
			...
			<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="section-title">Popular Collections</h3>
				<!-- /.nav-tabs -->
			</div>
...
<?php
$ret=mysqli_query($con,"select * from products where productPrice > 30000");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
...
<!-- customers stories -->
<div class="stories">
			   <center>Customers Stories</center>
			   </div>
				<!-- /.nav-tabs -->

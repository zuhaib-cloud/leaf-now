...
if(isset($_POST['submit']))
{
	...
	$merchantdetails=$_POST['merchantdetails'];
	$warranty=$_POST['warranty'];
	$cancellations=$_POST['cancellations'];
	$productscharge=$_POST['productShippingcharge'];
	$productavailability=$_POST['productAvailability'];
	
$sql=mysqli_query($con,"update  products set category='$category',subCategory='$subcat',productName='$productname',productCompany='$productcompany',productPrice='$productprice',productDescription='$productdescription',information='$information',instruction='$instruction',merchantdetails='$merchantdetails',warranty='$warranty',cancellations='$cancellations',shippingCharge='$productscharge',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
<div class="control-group">
<label class="control-label" for="basicinput">Informations</label>
<div class="controls">
<textarea  name="information"  placeholder="Enter Product information" rows="6" class="span8 tip">
<?php echo htmlentities($row['information']);?>
</textarea>  
</div>
</div>
...
<div class="controls">
<textarea  name="instruction"  placeholder="Enter Product instruction" rows="6" class="span8 tip">
...
<div class="control-group">
<label class="control-label" for="basicinput">Merchants Details</label>
<div class="controls">
<textarea  name="merchantdetails"  placeholder="Enter Product merchantdetails" rows="6" class="span8 tip">
<?php echo htmlentities($row['merchantdetails']);?>
</textarea>  
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Warranty and Guide</label>
<div class="controls">
<textarea  name="warranty"  placeholder="Enter Product warranty" rows="6" class="span8 tip">
<?php echo htmlentities($row['warranty']);?>
</textarea>  
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Returns and Cancellations</label>
<div class="controls">
<textarea  name="cancellations"  placeholder="Enter Product Description" rows="6" class="span8 tip">
<?php echo htmlentities($row['cancellations']);?>
</textarea>  
</div>
</div>
